...
- Verification checkout: fresh detached isolated worktree at `/tmp/a02-v-haunt.nIuCNZ`
...
The complete captured output is `/tmp/a02-v-haunt-exact-output.txt` with SHA-256
`4fc6e46cfa60c838b269de14065921e92fc5e5d0afd755cf6acb009297554719`.

## Independent evidence

- `git rev-parse HEAD`: exact requested source commit
...
This independent PASS accepts the A02-V-ENV prerequisite. It does not verify neural-model benefit
or unlock support-routing by itself.
